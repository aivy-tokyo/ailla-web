  ...
  public resetCamera() {
    ...
    if (headNode) {
      ...
      this._camera?.position.set(
        ...
        headWPos.y + yOffset,
        this._camera.position.z + zOffset
      );
      const cameraControlX = 0;
      const cameraControlY = -0.1;
      const cameraControlZ = 0;

      this._cameraControls?.target.set(headWPos.x + cameraControlX, headWPos.y + cameraControlY, headWPos.z + cameraControlZ);
      this._cameraControls?.update();
    }
  }
